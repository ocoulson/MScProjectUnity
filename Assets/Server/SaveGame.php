...
$saveGameData = anti_injection_login($_POST["myform_savedata"]);
    ...
    if ($unityHash != $phpHash){
        ...
        if($total) {
            ...
            if(!strcmp($playerPassword, $datas["Password"])) {
                $updateSQL = "UPDATE BioDomeUsers SET SaveGameData = '$saveGameData' WHERE Username = '$playerUsername';";
                $result = mysql_query($updateSQL) or die ("DATABASE ERROR!: " . mysql_error());
                echo "Game Data saved";
            } else {
